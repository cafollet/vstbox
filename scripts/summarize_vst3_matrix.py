...
def main() -> int:
    ...
    print("buffer  voices  deadline_ms  mean_ms   p95_ms   p99_ms   worst_ms  misses    rms      peak    peak_rss_mb")
    print("------  ------  -----------  --------  --------  --------  --------  ------  -------  -------  -----------")
    for row in rows:
        b, v, dl, mean, p95, p99, worst, misses, rms, peak, rss = row
        print(f"{b:6d}  {v:6d}  {dl:11.4f}  {mean:8.4f}  {p95:8.4f}  {p99:8.4f}  {worst:8.4f}  {misses:6d}  {rms:7.4f}  {peak:7.4f}  {rss:11.2f}")
    return 0
